...
/// \brief create a new skynet context 
/// \param : const char* name : service name
/// \param : const char* param : service param
/// \return : skynet_context struct if success or nullptr
struct skynet_context * 
...
/// \brief : push skynet_message to mq
/// \param : handle new serivce id
/// \param : skynet_message pointer
/// \return : if ok return 0, failed return -1
int
