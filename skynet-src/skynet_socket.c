 ...
 * Description : 初始化skynet的socket系统
 * Calls : socket_server_create
 * Input : None
 * Output : None
 */
void
...
// skynet开启监听
// ctx : [skynet_context]上下文
// host: [const char* ] 监听地址
// port : [int]监听端口
// backlog : [int]　tcp中 AB队列长之和
int
...
void
skynet_socket_setssl(struct skynet_context *ctx, int id) {
    socket_server_setssl(SOCKET_SERVER, id);
}
